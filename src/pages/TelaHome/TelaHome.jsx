...
function TelaHome() {
  ...
  async function criarTarefa() {
    ...
    try {
      await axios.post("https://api-tasks-14gq.onrender.com/api/Tasks/CriarTask", {
        id: userId,
        task: novaTarefa,
      });
  ...
  async function BuscaTarefa() {
    try {
      const response = await axios.get(
        `https://api-tasks-14gq.onrender.com/api/Tasks/ListarTask/${userId}`
      );
  ...
  async function DeleteTask(id) {
    ...
    try {
      await axios.delete(`https://api-tasks-14gq.onrender.com/api/Tasks/DeletarTask/${id}`, {
        headers: {
  ...
  async function DeleteRoutine(id) {
    ...
    try {
      await axios.delete(`https://api-tasks-14gq.onrender.com/api/Tasks/DeletarRotina/${id}`, {
        headers: {
          "Content-Type": "application/json",
        },
      });
  ...
  async function CreatingRoutine() {
    ...
    try {
      const response = await axios.post(
        `https://api-tasks-14gq.onrender.com/api/Tasks/CompletarTask/${userId}`,
        {
          NameTask: Tarefa,
          DateTask: DataTarefa,
        },
  ...
  async function GetRotinas() {
    try {
      const response = await axios.get(
        `https://api-tasks-14gq.onrender.com/api/Tasks/ListarRotina/${userId}`
      );
